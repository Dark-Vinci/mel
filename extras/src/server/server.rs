use {
    crate::app::app::ExtrasOperations,
...
pub struct Extras<E: ExtrasOperations>(E);

impl<E: ExtrasOperations> Extras<E> {
    pub fn new(a: E) -> Self {
        Self(a)
    }
}
...
#[async_trait]
impl<T: ExtrasOperations + Send + Sync + 'static> ExtrasService for Extras<T> {
    async fn ping(
        &self,
