...
use crate::email::email::{Email, EmailClient, EmailError, IntermediateString};
...
impl EmailClient for NoEmailClient {
    ...
    async fn send(&self, _recipient: Email, _subject: String, _body: Self::RichText) -> Result<(), EmailError> {
        Ok(())
    }
