...
use sdk::models::db::extras::short_url::{Model as ShortUrlTrack, ActiveModel, Entity as ShortUrlTrackEntity};
use sdk::models::others::extras::CreateShortUrlTrack;
use crate::connections::db::DB;

#[async_trait]
pub trait ShortUrlTrackRepository {
    async fn create(&self, payload: CreateShortUrlTrack, request_id: Uuid) -> Result<ShortUrlTrack, RepoError>;
